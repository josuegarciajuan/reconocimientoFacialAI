...
SERVICES=(rf-capturador rf-detector rf-clasificador rf-panel-control)
...
echo "    systemctl status rf-{capturador,detector,clasificador,panel-control}"
echo "    journalctl -u rf-detector -f"
