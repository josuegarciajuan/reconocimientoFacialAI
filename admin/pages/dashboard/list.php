...
<div class="col-span-12 mt-8">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
            <div class="report-box zoom-in">
                <div class="box p-5">
                    <div class="flex"><div class="menu__icon" data-feather="codepen" style="color:green"></div><div class="ml-auto"></div></div>
        ...
        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
            <div class="report-box zoom-in">
                <div class="box p-5">
                    <div class="flex"><div class="menu__icon" data-feather="copy" style="color:purple"></div><div class="ml-auto"></div></div>
        ...
        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
            <div class="report-box zoom-in">
                <div class="box p-5">
                    <div class="flex"><div class="menu__icon" data-feather="monitor" style="color:red"></div><div class="ml-auto"></div></div>
