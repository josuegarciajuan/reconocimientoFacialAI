 ...
 */
define("CONFIG_LIMITE_RAM",60); //limite de ram ocupada para seguir procesando videos
//define("CONFIG_LIMITE_VIDEOS",25); //numero de videos maximo que se pueden procesar a la vez
define("CONFIG_LIMITE_VIDEOS",50); //numero de videos maximo que se pueden procesar a la vez
