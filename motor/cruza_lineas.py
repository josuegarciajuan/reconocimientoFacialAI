...
while True:
                ...
                if cv2.contourArea(cnt) > 1500:
                    ...
                    if hay_doble_cruce:
                        ...
                        if time_elapsed < 1 and transcurrido>2:
                            ...
                            printLog("por tiempo no lo cuento")
                        printLog()
    ...
    # cv2.drawContours(frame, [area_pts], -1, (255, 0, 255), 2) # dibuja un rectangulo alrededor de la linea
    ...
    cv2.rectangle(frame, (frame.shape[1]-70, 270), (frame.shape[1]-5, 315), (0, 255, 0), 2)
    cv2.putText(frame, str(car_counter_dir1), (frame.shape[1]-55, 295),
                cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0,255,0), 2)

    cv2.rectangle(frame, (frame.shape[1]-70, 315), (frame.shape[1]-5, 370), (0, 255, 0), 2)
    cv2.putText(frame, str(car_counter_dir2), (frame.shape[1]-55, 350),
                cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0,255,0), 2)
