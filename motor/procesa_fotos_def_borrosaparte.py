...
def comprueba_enfocada(imagePath,name_file):
    ...
    if recortada:
        ...
        fm = variance_of_laplacian(gray)
        printLog("NO se puede recortar la face, por lo que aplico el umbral de la foto completa y su fm es:"+str(fm))
            ...
            if len(grupos[i][j])>0:
                ...
                if hay_cara:
                    ...
                    if hay_ganador:
                        ...
                        printLog("Hay ganador con estos puntos: "+str(puntuacion)+" y el umbral de las medias es: "+str(umbral_delasmedias))
