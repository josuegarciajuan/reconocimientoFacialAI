...
umbral=0.55                         # umbral para comprara foto a foto y ver con cual supera y el qe se usa para recompara cuando ya se tiene la media
umbral_solounaodos=0.52            # para comparar con las medias pero solo hay 1 o 2 fotos
umbral_delasmedias=0.55             # umbral cuando se a exo las medias
...
umbral_junto2=0.69                # la media de los qe superan y los qe no para esa persona qe se comparó
...
porcentaje_veces_supera=12          # si de todas las veces no supera este porcentaje de veces supera 
...
DIFERENCIA_ANCHO_OJOS=5
DIFERENCIA_ALTURAS=15

UMBRAL_BRILLO=350

"""
#este es el ultimo qe tenia anotado, voy a intentar afinarlo 1 poco mas..
umbral_parecidosentresi=0.39        # cuando va a clasificar las fotos y los que son parecidos entre si para decir qe esla misma persona
umbral=0.58                         # umbral para comprara foto a foto y ver con cual supera y el qe se usa para recompara cuando ya se tiene la media
umbral_solounaodos=0.55            # para comparar con las medias pero solo hay 1 o 2 fotos
...
"""
umbral_parecidosentresi=0.5
umbral=0.55
umbral_solounaodos=0.50
umbral_delasmedias=0.55
umbral_segurisimo=0.2155
veces_umbral_medias_augmenta=20
umbral_junto=0.66
umbral_junto2=0.68
porcentaje_veces_supera=30
DIFERENCIA_PROMERO_Y_SEGUNDO=0.04
MAXIMAS_REPETICIONES_GUARDADO=100
"""
