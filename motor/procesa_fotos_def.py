...
umbral=0.531                         # umbral para comprara foto a foto y ver con cual supera y el qe se usa para recompara cuando ya se tiene la media
umbral_solounaodos=0.515            # para comparar con las medias pero solo hay 1 o 2 fotos
# umbral_delasmedias=0.52             # umbral cuando se a exo las medias
umbral_delasmedias=0.531             # umbral cuando se a exo las medias
...
#umbral_junto=0.58                 # la media de los qe superan y los qe no para esa persona qe se comparó
umbral_junto=0.6                 # la media de los qe superan y los qe no para esa persona qe se comparó
#umbral_junto2=0.59                # la media de los qe superan y los qe no para esa persona qe se comparó
umbral_junto2=0.65                # la media de los qe superan y los qe no para esa persona qe se comparó

#porcentaje_veces_supera=10          # si de todas las veces no supera este porcentaje de veces supera 
porcentaje_veces_supera=15          # si de todas las veces no supera este porcentaje de veces supera 
DIFERENCIA_PROMERO_Y_SEGUNDO=0.06   # en los ganadores la diferencia qe tienen qe tener para qe alomejor sea el 2º
...
veces_umbral_medias_augmenta=15     # si se hay mas de X vces influya en los 2 umbrales de abajo
#umbral_junto=0.58                 # la media de los qe superan y los qe no para esa persona qe se comparó
umbral_junto=0.62                 # la media de los qe superan y los qe no para esa persona qe se comparó
#umbral_junto2=0.59                # la media de los qe superan y los qe no para esa persona qe se comparó
umbral_junto2=0.66                # la media de los qe superan y los qe no para esa persona qe se comparó

#porcentaje_veces_supera=10          # si de todas las veces no supera este porcentaje de veces supera 
porcentaje_veces_supera=2          # si de todas las veces no supera este porcentaje de veces supera 
DIFERENCIA_PROMERO_Y_SEGUNDO=0.06   # en los ganadores la diferencia qe tienen qe tener para qe alomejor sea el 2º
MAXIMAS_REPETICIONES_GUARDADO=100   # 
        ...
        for b2 in grupos[i]: 
            if len(grupos[i][j])>0:
                            ...
                            if veces_segurisimo>0:
                                ...
                                if veces2[g]>veces_umbral_medias_augmenta:
                                    ...
                                    if media_supera<umbral and media<umbral_junto2:
                                        activate=True
                                        printLog("supera umbral_junto2:media:"+str(media)+",umbral_junto2:"+str(umbral_junto2)+",media_supera:"+str(media_supera)+",umbral:"+str(umbral))
                                else:
                                    if media_supera<umbral and media<umbral_junto:
                                        activate=True
                                        printLog("supera umbral_junto:media:"+str(media)+",umbral_junto:"+str(umbral_junto)+",media_supera:"+str(media_supera)+",umbral:"+str(umbral))
                ...
                if hay_cara:
                    ...
                    """
                    printLog("Voy a sacar los 3 mejores encodings para guaradar para este usuario")
                    ...
                    printLog("para este nombre:"+ganador_name+", almacenamos esta puntuacion:"+str(puntuacion1))
